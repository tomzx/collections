...
use tomzx\Collections\EvictionPolicy\FirstInLastOut;

class FirstInLastOutTest extends \PHPUnit_Framework_TestCase {
	/**
	 * @var \tomzx\Collections\EvictionPolicy\FirstInLastOut
	 */
	...
	public function setUp()
	{
		...
		$this->evictionPolicy = new FirstInLastOut();
	}
